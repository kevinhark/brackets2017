...
(
    ...
    'Gonzaga', 'Northwestern', 'Princeton', 'West Virginia', 'Maryland', 'Florida St', 'VCU', 'Arizona',
    'Kansas', 'Michigan St', 'Iowa St', 'Purdue', 'Creighton', 'Oregon', 'Michigan', 'Louisville',
    'UNC', 'Arkansas', 'MTSU', 'Butler', 'Kansas St', 'UCLA', 'Wichita St', 'Kentucky',
),

'Owen':
(
    'Villanova', 'Virginia Tech', 'Virginia', 'E Tenn St', 'SMU', 'New Mexico St', 'South Carolina', 'Duke',
    'Gonzaga', 'Vanderbilt', 'Notre Dame', 'West Virginia', 'Xavier','Florida St', 'VCU', 'North Dakota',
    'Kansas', 'Miami', 'Iowa St', 'Purdue', 'Rhode Island', 'Oregon', 'Oklahoma St', 'Louisville',
    'UNC', 'Seton Hall', 'Minnesota', 'Butler', 'Cincinnati', 'Kent St', 'Wichita St', 'Kentucky',
),
...
(
    'Villanova', 'Wisconsin', 'Virginia', 'Florida', 'USC', 'Baylor', 'Marquette', 'Duke',
    'SDSU', 'Vanderbilt', 'Princeton', 'West Virginia', 'Xavier', 'Florida St', 'VCU', 'Arizona',
    'Kansas', 'Miami', 'Nevada', 'Purdue', 'Rhode Island', 'Oregon', 'Oklahoma St', 'Louisville',
    'UNC', 'Arkansas', 'MTSU', 'Butler', 'Cincinnati', 'UCLA', 'Dayton', 'Kentucky',
),
